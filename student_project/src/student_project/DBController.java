...
public class DBController {
	...
	public static int dataInsert(StudentData sd) {
		...
		try {
			//insert 쿼리 바인딩 (id,name,gender,kor,eng,math,total,avr,grade)
	...
	public static List<StudentData> dataSort(int menu) {
		...
		//데이터베이스 연결 확인
		if(con==null) System.out.println("mysql 연결실패");
	...
	public static int dataDelete(int id) {
		...
		//데이터베이스 연결 확인
		if(con==null) System.out.println("mysql 연결 실패.");
